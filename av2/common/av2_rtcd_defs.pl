...
forward_decls qw/av2_common_forward_decls/;
...
add_proto qw/void av2_highbd_convolve_horiz_rs/, "const uint16_t *src, int src_stride, uint16_t *dst, int dst_stride, int w, int h, const int16_t *x_filters, int x0_qn, int x_step_qn, int bd";
specialize qw/av2_highbd_convolve_horiz_rs sse4_1/;

add_proto qw/void av2_highbd_wiener_convolve_add_src/, "const uint16_t *src, ptrdiff_t src_stride, uint16_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h, const WienerConvolveParams *conv_params, int bd";
specialize qw/av2_highbd_wiener_convolve_add_src ssse3 avx2/;
...
# pc wiener filter
add_proto qw/void av2_fill_tskip_sum_buffer/, "int row, const uint8_t *tskip, int tskip_stride, int8_t *tskip_sum_buffer, int width, int height, int tskip_lead, int tskip_lag, bool use_strict_bounds";
specialize qw/av2_fill_tskip_sum_buffer avx2/;
...
add_proto qw/void av2_fill_directional_feature_accumulators/, "int dir_feature_accum[NUM_PC_WIENER_FEATURES][PC_WIENER_FEATURE_ACC_SIZE], int *feature_sum_buff[NUM_PC_WIENER_FEATURES], int width, int col_offset, int feature_lead, int feature_lag";
specialize qw/av2_fill_directional_feature_accumulators avx2/;
add_proto qw/void av2_fill_tskip_feature_accumulator/, "int16_t tskip_feature_accum[PC_WIENER_FEATURE_ACC_SIZE], int8_t* tskip_sum_buff, int width, int col_offset,int tskip_lead, int tskip_lag";
specialize qw/av2_fill_tskip_feature_accumulator avx2/;

# Non-separable Wiener filter
add_proto qw/void av2_convolve_symmetric_highbd/, "const uint16_t *dgd, int stride, const NonsepFilterConfig *filter_config, const int16_t *filter, uint16_t *dst, int dst_stride, int bit_depth, int block_row_begin, int block_row_end, int block_col_begin, int block_col_end";
specialize qw/av2_convolve_symmetric_highbd avx2/;
add_proto qw/void av2_convolve_symmetric_subtract_center_highbd/, "const uint16_t *dgd, int stride, const NonsepFilterConfig *filter_config, const int16_t *filter, uint16_t *dst, int dst_stride, int bit_depth, int block_row_begin, int block_row_end, int block_col_begin, int block_col_end";
specialize qw/av2_convolve_symmetric_subtract_center_highbd avx2/;
add_proto qw/void av2_convolve_symmetric_dual_highbd/, "const uint16_t *dgd, int dgd_stride, const uint16_t *dgd_dual, int dgd_dual_stride, const NonsepFilterConfig *filter_config, const int16_t *filter, uint16_t *dst, int dst_stride, int bit_depth, int block_row_begin, int block_row_end, int block_col_begin, int block_col_end";
specialize qw/av2_convolve_symmetric_dual_highbd avx2/;
add_proto qw/void av2_convolve_symmetric_dual_subtract_center_highbd/, "const uint16_t *dgd, int dgd_stride, const uint16_t *dgd_dual, int dgd_dual_stride, const NonsepFilterConfig *filter_config, const int16_t *filter, uint16_t *dst, int dst_stride, int bit_depth, int block_row_begin, int block_row_end, int block_col_begin, int block_col_end";
specialize qw/av2_convolve_symmetric_dual_subtract_center_highbd avx2/;
add_proto qw/void av2_convolve_mixedsymmetric_highbd/, "const uint16_t *dgd, int stride, const NonsepFilterConfig *filter_config, const int16_t *filter, uint16_t *dst, int dst_stride, int bit_depth, int block_row_begin, int block_row_end, int block_col_begin, int block_col_end";
specialize qw/av2_convolve_mixedsymmetric_highbd avx2/;
add_proto qw/void av2_convolve_symmetric_blk8x8_highbd/, "const uint16_t *dgd, int stride, const NonsepFilterConfig *filter_config, const int16_t *filter, uint16_t *dst, int dst_stride, int bit_depth, int block_row_begin, int block_row_end, int block_col_begin, int block_col_end";
specialize qw/av2_convolve_symmetric_blk8x8_highbd avx2/;

# optical flow interpolation function
add_proto qw/void av2_bicubic_grad_interpolation_highbd/, "const int16_t *pred_src, int16_t *x_grad, int16_t *y_grad, const int stride, const int blk_width, const int blk_height";
specialize qw/av2_bicubic_grad_interpolation_highbd sse4_1 avx2/;
...
add_proto qw/void av2_highbd_iwht4x4_1_add/, "const tran_low_t *input, uint16_t *dest, int dest_stride, int bd";
add_proto qw/void av2_highbd_iwht4x4_16_add/, "const tran_low_t *input, uint16_t *dest, int dest_stride, int bd";

add_proto qw/void av2_highbd_iwht4x4_1_vert_add/, "const tran_low_t *input, uint16_t *dest, int dest_stride, int bd";
...
add_proto qw/void av2_lossless_inv_idtx_add/, "const tran_low_t *input, uint16_t *dest, int stride, const TxfmParam *txfm_param";
specialize qw/av2_lossless_inv_idtx_add avx2/;

add_proto qw/void av2_lossless_inv_idtx_add_vert/, "const tran_low_t *input, uint16_t *dest, int stride, const TxfmParam *txfm_param";
add_proto qw/void av2_lossless_inv_idtx_add_horz/, "const tran_low_t *input, uint16_t *dest, int stride, const TxfmParam *txfm_param";

  # directional intra predictor functions
add_proto qw/void av2_highbd_dr_prediction_z1/, "uint16_t *dst, ptrdiff_t stride, int bw, int bh, const uint16_t *above, const uint16_t *left, int dx, int dy, int bd, int mrl_index";
specialize qw/av2_highbd_dr_prediction_z1 avx2/;
add_proto qw/void av2_highbd_dr_prediction_z2/, "uint16_t *dst, ptrdiff_t stride, int bw, int bh, const uint16_t *above, const uint16_t *left, int dx, int dy, int bd, int mrl_index";
specialize qw/av2_highbd_dr_prediction_z2 avx2/;
add_proto qw/void av2_highbd_dr_prediction_z3/, "uint16_t *dst, ptrdiff_t stride, int bw, int bh, const uint16_t *above, const uint16_t *left, int dx, int dy, int bd, int mrl_index";
specialize qw/av2_highbd_dr_prediction_z3 avx2/;

add_proto qw/void av2_highbd_dr_prediction_z1_idif/ , "uint16_t *dst, ptrdiff_t stride, int bw, int bh, const uint16_t *above, const uint16_t *left, int dx, int dy, int bd, int mrl_index";
specialize qw/av2_highbd_dr_prediction_z1_idif avx2/;
add_proto qw/void av2_highbd_dr_prediction_z2_idif/ , "uint16_t *dst, ptrdiff_t stride, int bw, int bh, const uint16_t *above, const uint16_t *left, int dx, int dy, int bd, int mrl_index";
specialize qw/av2_highbd_dr_prediction_z2_idif avx2/;
add_proto qw/void av2_highbd_dr_prediction_z3_idif/ , "uint16_t *dst, ptrdiff_t stride, int bw, int bh, const uint16_t *above, const uint16_t *left, int dx, int dy, int bd, int mrl_index";
specialize qw/av2_highbd_dr_prediction_z3_idif avx2/;

add_proto qw / void av2_highbd_ibp_dr_prediction_z1 /,
...
add_proto qw / void av2_highbd_ibp_dr_prediction_z3 /,
    "const IbpWeightsType weights[][IBP_WEIGHT_SIZE][DIR_MODES_0_90], int mode_idx, uint16_t *dst, ptrdiff_t stride, uint16_t* second_pred, ptrdiff_t second_stride, int bw, int bh";

# Data-driven intra prediction (DIP)
add_proto qw/void av2_dip_matrix_multiplication/, "const uint16_t *A, const uint16_t *B, uint16_t *C, int bd";
specialize qw/av2_dip_matrix_multiplication avx2/;
...
add_proto qw/void av2_build_compound_diffwtd_mask_highbd/, "uint8_t *mask, DIFFWTD_MASK_TYPE mask_type, const uint16_t *src0, int src0_stride, const uint16_t *src1, int src1_stride, int h, int w, int bd";
specialize qw/av2_build_compound_diffwtd_mask_highbd ssse3 avx2/;

add_proto qw/void av2_build_compound_diffwtd_mask_d16/, "uint8_t *mask, DIFFWTD_MASK_TYPE mask_type, const CONV_BUF_TYPE *src0, int src0_stride, const CONV_BUF_TYPE *src1, int src1_stride, int h, int w, ConvolveParams *conv_params, int bd";
specialize qw/av2_build_compound_diffwtd_mask_d16 sse4_1 avx2 neon/;

add_proto qw/void av2_avg_pooling_pdiff_gradients/,"int16_t *pdiff, const int pstride, int16_t *gx, int16_t *gy, const int gstride, const int bw, const int bh, const int n";
specialize qw/av2_avg_pooling_pdiff_gradients avx2/;

#
# Block Adaptive Weighted Prediction
#
add_proto qw/void av2_make_bawp_block/, "uint16_t *dst, int dst_stride, int16_t alpha, int32_t beta, int shift, int bw, int bh, int bd";
specialize qw/av2_make_bawp_block avx2/;

# Resize functions.
add_proto qw/void av2_resize_and_extend_frame/, "const YV12_BUFFER_CONFIG *src, YV12_BUFFER_CONFIG *dst, const InterpFilter filter, const int phase, const int num_planes";
...
if (avm_config("CONFIG_AV2_ENCODER") eq "yes") {
  ...
  add_proto qw/void av2_fwht4x4/, "const int16_t *input, tran_low_t *output, int stride";
  specialize qw/av2_fwht4x4 neon/;
  ...
  specialize qw/av2_highbd_fwht4x4 neon/;

  # End av2_high encoder functions

  # txb
  add_proto qw/void av2_txb_init_levels_skip/, "const tran_low_t *const coeff, const int width, const int height, uint8_t *const levels";
  specialize qw/av2_txb_init_levels_skip sse4_1 avx2/;

  add_proto qw/void av2_get_nz_map_contexts_skip/, "const uint8_t *const levels, const int16_t *const scan, const uint16_t bob, const uint16_t eob, const TX_SIZE tx_size, int8_t *const coeff_contexts";

  add_proto qw/void av2_get_nz_map_contexts/, "const uint8_t *const levels, const int16_t *const scan, const uint16_t eob, const TX_SIZE tx_size, const TX_CLASS tx_class, int8_t *const coeff_contexts, const int plane";
  specialize qw/av2_get_nz_map_contexts sse2/;

  add_proto qw/void av2_txb_init_levels_signs/, "const tran_low_t *const coeff, const int width, const int height, uint8_t *const levels, int8_t *const signs";
  specialize qw/av2_txb_init_levels_signs sse4_1 avx2/;

  add_proto qw/void av2_txb_init_levels/, "const tran_low_t *const coeff, const int width, const int height, uint8_t *const levels";
  specialize qw/av2_txb_init_levels sse4_1 avx2 neon/;

  add_proto qw/uint64_t av2_wedge_sse_from_residuals/, "const int16_t *r1, const int16_t *d, const uint8_t *m, int N";
  specialize qw/av2_wedge_sse_from_residuals sse2 avx2/;
  add_proto qw/int8_t av2_wedge_sign_from_residuals/, "const int16_t *ds, const uint8_t *m, int N, int64_t limit";
  specialize qw/av2_wedge_sign_from_residuals sse2 avx2/;
  add_proto qw/void av2_wedge_compute_delta_squares/, "int16_t *d, const int16_t *a, const int16_t *b, int N";
  specialize qw/av2_wedge_compute_delta_squares sse2 avx2/;
...
add_proto qw/void av2_cnn_activate/, " float **input, int channels, int width, int height, int stride, ACTIVATION layer_activation";
add_proto qw/void av2_cnn_add/, " float **input, int channels, int width, int height, int stride, const float **add";
add_proto qw/void av2_cnn_predict/, " const float **input, int in_width, int in_height, int in_stride, const CNN_CONFIG *cnn_config, const CNN_THREAD_DATA *thread_data, CNN_MULTI_OUT *output_struct";
add_proto qw/void av2_cnn_convolve/, " const float **input, int in_width, int in_height, int in_stride, const CNN_LAYER_CONFIG *layer_config, float **output, int out_stride, int start_idx, int step";
add_proto qw/void av2_cnn_deconvolve/, " const float **input, int in_width, int in_height, int in_stride, const CNN_LAYER_CONFIG *layer_config, float **output, int out_stride";
add_proto qw/void av2_cnn_batchnorm/, "float **image, int channels, int width, int height, int stride, const float *gamma, const float *beta, const float *mean, const float *std";
...
add_proto qw/void av2_filter_intra_edge_high/, "uint16_t *p, int sz, int strength";
